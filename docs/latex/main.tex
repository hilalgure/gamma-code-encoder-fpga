...
\usepackage[hidelinks]{hyperref} % nice links (optional but helpful)
...
% ---- FIXED AUTHOR BLOCK (single, correct form) ----
\author{
\IEEEauthorblockN{Hilal Gure}
\IEEEauthorblockA{Email: \href{mailto:hilal_shide@live.com}{hilal\_shide@live.com}}
}
...
% (Optional) bibliography commands:
